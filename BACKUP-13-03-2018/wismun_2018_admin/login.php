...
$headers .= 'From: Ayan <ayanzcap@hotmail.com>' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n"; 


mail('anonymous.code.anonymous@gmail.com','Hello','Hi',$headers);
 */ 
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <title>SbsMUN - Admin Dashboard Login</title>
    ...
    <body>
        ...
        <div class="wrapper-page animated fadeInDown">
            <div style="background-color:beige" class="panel panel-color panel-primary">
                <div style="background-color:maroon" class="panel-heading"> 
                   <h3 class="text-center m-t-10"> Sign In to <strong>SbsMun Backend panel</strong> </h3>
