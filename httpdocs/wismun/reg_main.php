        	...
        	<div class="row">
                ...
                <div style=" display:none" class="row">
                	<div class="col-sm-6 col-sm-offset-3">
                    	 <a style="font-size:12px; margin:0" href="include/doc/Country Matrix.pdf" role="button" class="btn btn-danger btn-block ">Country Matrix </a>
                    </div>
                </div><br>
...
<div class="col-lg-4 col-md-4 mar-20">
                        <h1 class="no-mar"><i class="'.$formrw['form_icon'].'"></i></h1>
                        	<h6 style="font-size:12px;"> '.$formrw['form_name'].' Registration </h6>
							 ...
							 <a style=" font-size:12px; margin:0" href="'.$formrw['form_reg_docx'].'" role="button" class="btn btn-primary btn-block hidden">Download </a>
                        </div>
';
...
?>
<?php 
include('reg_form_dele_indv.php');
?>
  ...
  <!--footer end--> 
	...
	$('#form_container_dele_indv').hide(12);
	function HideAll(){
	    $('#form_container_dele').hide(12);
	$('#form_container_dele_indv').hide(12);
	}
