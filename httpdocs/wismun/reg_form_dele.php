                            	...
                            	<div class="row">
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                            ...
                                            <input name="pinc" type="text" value="NA" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    	<div class="form-group">
                                            <label>City<br></label>
                                            <input name="cty" type="text" value="Dubai" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="row">
	<div class="col-sm-4 col-sm-offset-4">
        <div class="form-group">
		        <label>Expected Delegate Strength (Numeric Only)</label>
...
Please Note: This registration form is only applicable for school delegations. 
</div>
<br>
<br>
