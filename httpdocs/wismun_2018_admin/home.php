                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                            <?php
$getmain = "SELECT *,ifnull(oi_valid,1) as oi_valid_no,ifnull(sumqtyorder,0) as sqoa ,(ifnull(pr_qty, 0) + ifnull(sh_qty, 0)) as 'total_sum'
FROM pr_list_final pl
 left join order_sum_qty osq on pl.pr_id = osq.oi_rel_pr_id
 where pl.pr_valid =1  and ifnull(osq.oi_valid,1) = 1 
